    ...
    <section className="w-full py-8 bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center p-6 bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-2xl transition-transform duration-300">
          <div className="w-14 h-14 flex items-center justify-center rounded-full bg-indigo-600/20 mb-6">
            <FiFeather className="text-indigo-600 text-3xl" />
          </div>
        ...
        <div className="flex flex-col items-center text-center p-6 bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-2xl transition-transform duration-300">
          <div className="w-14 h-14 flex items-center justify-center rounded-full bg-indigo-600/20 mb-6">
            <GiProcessor className="text-indigo-600 text-3xl" />
          </div>
          <h3 className="text-base font-semibold mb-3">Cutting-edge</h3>
          <p className="text-gray-500 text-sm">
            Our state-of-the-art technology helps you complete a standout resume
            easily and quickly.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center p-6 bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-2xl transition-transform duration-300">
          <div className="w-14 h-14 flex items-center justify-center rounded-full bg-indigo-600/20 mb-6">
            <FiZap className="text-indigo-600 text-3xl" />
          </div>
